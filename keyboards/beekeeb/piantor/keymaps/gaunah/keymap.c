...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x6_3(KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSLS,
                             KC_TRNS, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_PMNS, KC_PEQL, KC_GRV, KC_LBRC, KC_RBRC, KC_PIPE,
                             KC_TRNS, KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_UNDS, KC_PLUS, KC_TILD, KC_LCBR, KC_RCBR, KC_TRNS,
